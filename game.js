...
function drawEnemyShape(enemy) {
  ...
  switch (enemy.behavior) {
    case "slow":
      ...
      ctx.closePath();
      ctx.fill(); ctx.stroke();
      ctx.beginPath(); ctx.arc(enemy.pos.x, enemy.pos.y, enemy.radius * 0.35, 0, Math.PI * 2); ctx.stroke();
      break;
    case "sneak":
      ctx.save();
    ...
    case "shooter": {
      ...
      ctx.beginPath(); ctx.arc(enemy.pos.x, enemy.pos.y, enemy.radius * 0.4, 0, Math.PI * 2); ctx.stroke();
      break;
    }
    case "splitter":
